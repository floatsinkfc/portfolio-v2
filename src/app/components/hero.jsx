  ...
  return (
    <div className="w-screen h-screen flex">
      <div className="w-screen h-screen flex items-center justify-center flex-col gap-[20px] z-[2]">
        <h1 className= "font-inked text-[120px] font-normal flex flex-row">Hi, I&#39;m Zi Jun Wang</h1>
        <div className="flex items-center ">
          <h1 className= "text-[#828282] font-inked text-[26px] font-normal">Software Engineer</h1>
        ...
        <div className="flex gap-[100px] z-[1] mt-5">
      ...
      <div className="z-0">
        <Image src={mountain} alt="" className="h-[470px] w-[528px] absolute top-[360px] -left-[228px]"></Image>
        <Image src={bamboo} alt="" className="h-[388px] w-[568px] absolute top-[-110px] -left-[206px]"></Image>
        <Image src={boat} alt="" className="h-[226px] w-[226px] absolute top-[187px] right-[190px]"></Image>
        <Image src={bridge} alt="" className="h-[362px] w-[362px] absolute top-[497px] right-[-75px]"></Image>
        
      </div>
      <Image src={crane} alt="" className="h-[99px] w-[158px] absolute top-[138px] right-[48px] animate-wiggle animate-infinite hover:animate-fade-right hover:animate-reverse hover:animate-once z-[10] "></Image>
